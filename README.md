...
- **Browse** — search, filter by category, rewards, or competition cycle, and view app details. Competition entries carry a public `Cycle N` badge. Home highlights featured picks, trending (most viewed in the last 7 days), and curated collections. Every
...
- **Submit** — developers log in with their Nimiq wallet and submit apps at `/submit`
  ...
  apps via `/apps/{slug}/update` or manage them from `/my-apps`. Competition entrants

...
| `competition_results` | `{ cycle, score, place? }[]` | Per-cycle scores/places. Admin create/update upserts by cycle (`score` 0 until official totals). Public submit ignores this field. |
